...
List<Teacher> teachers = [
  ...
  Teacher("Josias Mansour", "DIAMITANI", "Auditeur junior", "Je suis extrêmement hyper super giga méga sympa, et les enfants m'adorent. En fait tout le monde m'adore, meme si ça n'a rien à avoir avec tam tam tamtam tam tamtam tam tamtam tam tamtam tam tamtam tam tamtam tam tam", 1, false, 
  numberOfVotes: 50, 
  adress: "El Ghazalani 3, SETTAT.", 
  education: "Baccalauréat.", 
  ...
  subjectTeached: subjectList),
  Teacher("Abdoul", "BIKIENGA", "Marketeur", "Je suis extrêmement hyper super giga méga sympa, et les enfants m'adorent. En fait tout le monde m'adore, meme si ça n'a rien à avoir avec tam tam tamtam tam tamtam tam tamtam tam tamtam tam tamtam tam tamtam tam tam", 5, true, 
  numberOfVotes: 50, 
  adress: "El Ghazalani 3, SETTAT.", 
  education: "Baccalauréat.", 
