...
class EditProfilePage extends StatefulWidget {
  EditProfilePage();
  @override
  _EditProfilePageState createState() => _EditProfilePageState(currentUser);
}
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  _EditProfilePageState(this.user){
    ...
    adressController = TextEditingController(text: this.user.fullAdress);
...
class ProfilPicture extends StatefulWidget {
  ...
  ProfilPicture(this.user, this._scaffoldState);
  @override
  _ProfilPictureState createState() => _ProfilPictureState(this.user);
}

class _ProfilPictureState extends State<ProfilPicture> {
  User user;
  bool profilePicturechanging = false;
  Widget image;
  File _image;

  _ProfilPictureState(this.user);
